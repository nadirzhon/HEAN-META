...
def example_initial_generation() -> None:
    ...
    code = generator.generate_agent(
        prompt_type="initial", output_path="examples/generated_agent_1.py"
    )
...
def example_batch_generation() -> None:
    ...
    # Generate 5 agents
    codes = generator.generate_initial_agents(count=5, output_dir="examples/generated_agents")
...
def example_creative() -> None:
    ...
    code = generator.generate_creative_agent(output_path="examples/creative_agent.py")
