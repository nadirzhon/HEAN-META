...
class ConsensusSwarmIntelligence:
    ...
    def __init__(
        self, bus: EventBus, num_agents: int = 100, consensus_threshold: float = 0.80
    ) -> None:
    ...
    def get_consensus(self, symbol: str, strategy_id: str = "swarm_consensus") -> Optional[Signal]:
        ...
        try:
            ...
            self._current_consensus[symbol] = {
                "consensus": side,
                "consensus_percentage": max(
                    consensus_result.buy_vote_percentage, consensus_result.sell_vote_percentage
                ),
